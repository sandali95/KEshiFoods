...
=======
                    ...
                    <li><a href="<?php echo base_url(); ?>index.php/View_bills/index"><i class="fa fa-circle-o"></i> View Bills</a>
>>>>>>> 05e5f01e8387fcab107fc070ce805d4c84a40684
                    </li>
            ...
            <li class="treeview">
                <a href="">
                    <i class="fa fa-th"></i> <span>Stocks</span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url(); ?>index.php/View_stocks"><i class="fa fa-circle-o"></i> View Stocks</a>
                    </li>
            ...
            <li>
                <a href="assetspages/calendar.html">
